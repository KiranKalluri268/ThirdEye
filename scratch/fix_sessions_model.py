...
with open('sessions_app/models.py', 'w', encoding='utf-8') as f:
    f.write(content)

print('SUCCESS - written sessions_app/models.py')
print('Length:', len(content))

# Verify
with open('sessions_app/models.py', 'r', encoding='utf-8') as f:
    check = f.read()
print('Has LearningSession:', 'LearningSession' in check)
print('Has EngagementRecord:', 'EngagementRecord' in check)
print('Has SessionEnrollment:', 'SessionEnrollment' in check)
